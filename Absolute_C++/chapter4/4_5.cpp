...
int main()
{
    int diammeterSmall, diameterLarge;
    double priceSmall, priceLarge;

    getData(diammeterSmall, priceSmall, diameterLarge, priceLarge);
    giveResults(diammeterSmall, priceSmall, diameterLarge, priceLarge);
