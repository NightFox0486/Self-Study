public class ArrayList {
    ...
    public void extend() {
        arraysize++;
        Object[] elementDataExtended = new Object[size + 1];
        // System.arraycopy(elementData, 0, elementDataExtended, 0, size - 1);
        // elementDataExtended = Arrays.copyOf(elementData, size - 1);
        for (int i = 0; i < size; i++) {
            elementDataExtended[i] = elementData[i];
        }
        elementData = elementDataExtended;
    }
